...
import { Bt as onUpdated, Ft as onMounted, Kn as ref, Mt as onBeforeUpdate, Ot as nextTick$1, U as computed, Ut as provide, Yn as shallowRef, gn as watch, jt as onBeforeUnmount, nt as defineComponent, pt as h, xt as inject } from "./vue.runtime.esm-bundler-BKMCCr0F.js";
...
function getChildren(originalSlots = {}, slidesRef, oldSlidesRef) {
	...
	Object.keys(originalSlots).forEach((slotName) => {
		...
		getSlidesFromElements(slotFn(), slotName);
	});
...
var SwiperSlide = defineComponent({
	name: "SwiperSlide",
	props: {
		tag: {
			type: String,
...
var useSwiperSlide = () => inject("swiperSlide");
var useSwiper = () => inject("swiper");
//#endregion
